...
const columns = [
  ...
  { id: 'TransactionHash', label: 'TransactionHash', minWidth: 170 },
];
...
const  StickyHeadTable = ({transactionDetail})=> {
    ...
    <Paper className={classes.root}>
      <TableContainer className={classes.container}>
        <Table stickyHeader aria-label="sticky table">
          ...
          <TableBody>
            {transactionDetail?.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((row) => {
              return (
